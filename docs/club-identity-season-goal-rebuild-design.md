...
- 给玩家新增 `age` 字段，并让年龄长期影响敏捷、体能、心态和经验，而不是只用固定核心属性描述整个生涯。
...
| 年龄阶段 | 敏捷 | 体能 | 心态 | 经验 | 设计含义 |
|---|---|---|---|---|---|
| 16-18 | 上限高但不稳定 | 恢复好 | 波动大 | 低 | 新人天赋期 |
| 19-23 | 敏捷成长黄金期 | 体能强 | 逐渐稳定 | 快速积累 | 上升期 |
| 24-27 | 敏捷稳定 | 体能稳定 | 心态成熟 | 经验高 | 巅峰期 |
| 28-31 | 敏捷小幅下降 | 体能小幅下降 | 心态更稳 | 经验更高 | 老将稳定期 |
| 32+ | 敏捷下降明显 | 体能下降明显 | 心态高 | 经验高 | 老将末期 |

核心原则：

- 年龄会适当压低敏捷和体能，尤其是高龄阶段。
- 年龄会适当提高心态和经验，体现老将阅读比赛、抗压和处理关键局的能力。
...
- 玩家创建时写入 `age`。
- 新赛季开始时玩家 `age + 1`。
- 年龄对敏捷、体能、心态、经验使用派生修正或成长倍率，不直接无预警修改永久核心属性。
...
- 玩家新增 `age` 字段。
- 新赛季时玩家年龄递增。
- 年龄通过派生修正或成长倍率影响敏捷、体能、心态和经验。

验收：

- 对手情报、MVP 和赛事表现能引用具体选手。
- 年轻选手体现敏捷、体能成长潜力，但心态和经验不足。
- 老将体现心态、经验优势，但敏捷、体能成长或表现略受影响。
- 玩家年龄不会无预警永久扣除已有核心属性。
...
- 玩家的年龄会参与职业生涯变化，年轻时更依赖敏捷和体能，老将阶段更依赖心态和经验。
